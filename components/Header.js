...
function Header({ user }) {
  ...
  return (
    <div className="flex bg-pink-200 sticky top-0 z-50 shadow-lg h-16 items-center">
      ...
      <Link href={`/${user.username}`} passHref>
        <div className="flex lg:ml-10 items-center h-12 sm:hover:bg-pink-300 px-1 rounded-3xl m-3 cursor-pointer">
          <Image
